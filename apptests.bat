...
php application.php app:build-env
C:\laragon\bin\php\php-8.1.3-nts-Win32-vs16-x64/php ./vendor/bin/phpunit tests/Unit/GamePlayTest.php

php application.php app:build-env
C:\laragon\bin\php\php-8.1.3-nts-Win32-vs16-x64/php ./vendor/bin/phpunit tests/Unit/HandIdentifierTest.php

php application.php app:build-env
C:\laragon\bin\php\php-8.1.3-nts-Win32-vs16-x64/php ./vendor/bin/phpunit tests/Unit/HandTypeTest.php

php application.php app:build-env
C:\laragon\bin\php\php-8.1.3-nts-Win32-vs16-x64/php ./vendor/bin/phpunit  tests/Unit/TableSeatTest.php